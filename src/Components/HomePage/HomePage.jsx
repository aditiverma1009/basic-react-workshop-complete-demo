...
class HomePage extends Component {
  ...
  render() {
    const { blogList, blogImage, onFormSubmit } = this.props;
    const { title, desc, imageurl } = this.state;
    return (
      <>
        ...
        <div className="body">
          <div className="bloglist">
            <div className="add-blog">
              <form onSubmit={(event) => onFormSubmit(event, { title, desc, imageurl })}>
                Post Title:
                <input onChange={(event) => this.handleFieldChange(event, 'title')} type="text" name="title" placeholder="title" />
                Description:
                <textarea onChange={(event) => this.handleFieldChange(event, 'desc')} name="description" placeholder="description" />
                ImageURL:
                <input onChange={(event) => this.handleFieldChange(event, 'imageurl')} type="text" name="imageurl" placeholder="imageURL" />
          ...
          <div className="side-bar">
            ...
            <div className="follow-me">
              ...
              <a href="https://www.linkedin.com/in/aditiverma1009/">
                <img
              ...
              <a href="https://twitter.com/aditiverma1009">
                <img
              ...
              <a href="https://www.instagram.com/aditi_verma_artwork/">
                <img
